! function (t, e) {
        ...
        class d extends l {
                ...
                onInit() {
                        ...
                        // for (let t = 0; t < 4; t++) {
                        //         let e = .15 * Math.cos(t / 4 * Math.PI * 2)*0,
                        //                 s = .15 * Math.sin(t / 4 * Math.PI * 2)*0,
                        ...
                        const g = new p.LineBasicMaterial({
                                ...
                                y = new p.SphereGeometry(18 * this.options.size, 30, 18),
                                M = new p.EdgesGeometry(y);
                        this.sphere = new p.LineSegments(M, g), this.sphere.position.set(20, 0, 50), this.cont2.add(this.sphere), this.cont2.rotation.x = -.25
                }
                onUpdate() {
                        let t;
